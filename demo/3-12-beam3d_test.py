...
####   ax3.set_xticks([-1,noe+1],1)
####   ax3.set_xlabel(r"$Element ID$")
####   ax1.set_ylabel(r"$Mx/kNm$")
####   ax2.set_ylabel(r"$My/kNm$")
####   ax3.set_ylabel(r"$Mz/kNm$")
####   ax3.xaxis.set_major_locator(MultipleLocator(1))
####   ax1.xaxis.set_major_locator(MultipleLocator(1))
####   ax2.xaxis.set_major_locator(MultipleLocator(1))
######   ax2.set_ylim([-7,7])
####   
####   for i in xrange(noe):
####      ax1.plot([i-0.5,i+0.5],[Mx1[i],Mx2[i]],"gs-")
####      ax2.plot([i-0.5,i+0.5],[My1[i],My2[i]],"rs-")
####      ax3.plot([i-0.5,i+0.5],[Mz1[i],Mz2[i]],"ks-")
##
##   plt.show()
##   
